...
import com.luman.sofa.common.util.enums.ErrorEnum;
import com.luman.sofa.common.util.exception.BizException;
import com.luman.sofa.common.util.exception.CheckUtil;
import com.luman.sofa.common.util.helper.RHelper;
import com.luman.sofa.common.util.util.LoggerUtil;
import com.luman.sofa.common.util.util.TimeUtil;
...
public class RestLogAspect extends LogAspect {
	 ...
	 */
	@Pointcut("@within(com.luman.sofa.common.monitor.rest.RestLog) && execution(public * *(..))")
